...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private int size;
    private HashMap<T, Integer> index;  // To store item index
    ...
    private void swap(int index1, int index2) {
        ...
        index.put(contents[index1].item(), index1);
        index.put(contents[index2].item(), index2);
    }
    ...
    private void sink(int index) {
        ...
        if (leftIndex(index) <= size()) {
            ...
            if (min(smallerIndex, index) == smallerIndex) {
