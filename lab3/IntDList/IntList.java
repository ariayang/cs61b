...
public class IntList {
    ...
    public static void dSquareList(IntList L) {
        ...
        while (L != null) {
            ...
            L = L.rest;  //loop through IntList L
        }
    }
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList a = new IntList(A.first, null); //Create a new IntList for return
        IntList cursor = a;
        A = A.rest;
        while (A != null) {
        ...
        //cursor.rest = new IntList(B.first, null);
        //B = B.rest;
        while (B != null) {
            cursor.rest = new IntList(B.first, null);
            B = B.rest;
    ...
    public static IntList reverse(IntList A) {
        ...
        while (cursor != null) {
            IntList tempList = cursor.rest;
            cursor.rest = frontOfReversed;
            frontOfReversed = cursor;
            cursor = tempList;
        }
